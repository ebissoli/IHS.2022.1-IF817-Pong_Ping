...
// 
// Generated using ACDS version 14.0 200 at 2022.09.30.14:29:54
...
module pcihellocore_mm_interconnect_0 (
	...
	wire  [113:0] ledr_s1_agent_rf_source_data;                                           // ledR_s1_agent:rf_source_data -> ledR_s1_agent_rsp_fifo:in_data
	...
	wire  [113:0] ledr_s1_agent_rsp_fifo_out_data;                                        // ledR_s1_agent_rsp_fifo:out_data -> ledR_s1_agent:rf_sink_data
	...
	wire  [113:0] ledg_s1_agent_rf_source_data;                                           // ledG_s1_agent:rf_source_data -> ledG_s1_agent_rsp_fifo:in_data
	...
	wire  [113:0] ledg_s1_agent_rsp_fifo_out_data;                                        // ledG_s1_agent_rsp_fifo:out_data -> ledG_s1_agent:rf_sink_data
	...
	wire  [112:0] hex_display_s1_agent_rp_data;                                           // hex_display_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [112:0] ledr_s1_agent_rp_data;                                                  // ledR_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [112:0] ledg_s1_agent_rp_data;                                                  // ledG_s1_agent:rp_data -> router_007:sink_data
	wire          ledg_s1_agent_rp_ready;                                                 // router_007:sink_ready -> ledG_s1_agent:rp_ready
	wire          push_button_s1_agent_rp_endofpacket;                                    // push_button_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	wire          push_button_s1_agent_rp_valid;                                          // push_button_s1_agent:rp_valid -> router_008:sink_valid
	wire          push_button_s1_agent_rp_startofpacket;                                  // push_button_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire  [112:0] push_button_s1_agent_rp_data;                                           // push_button_s1_agent:rp_data -> router_008:sink_data
	wire          push_button_s1_agent_rp_ready;                                          // router_008:sink_ready -> push_button_s1_agent:rp_ready
	...
	wire  [112:0] ledr_s1_burst_adapter_source0_data;                                     // ledR_s1_burst_adapter:source0_data -> ledR_s1_agent:cp_data
	wire          ledr_s1_burst_adapter_source0_ready;                                    // ledR_s1_agent:cp_ready -> ledR_s1_burst_adapter:source0_ready
	wire    [7:0] ledr_s1_burst_adapter_source0_channel;                                  // ledR_s1_burst_adapter:source0_channel -> ledR_s1_agent:cp_channel
	...
	wire  [112:0] ledg_s1_burst_adapter_source0_data;                                     // ledG_s1_burst_adapter:source0_data -> ledG_s1_agent:cp_data
	wire          ledg_s1_burst_adapter_source0_ready;                                    // ledG_s1_agent:cp_ready -> ledG_s1_burst_adapter:source0_ready
	wire    [7:0] ledg_s1_burst_adapter_source0_channel;                                  // ledG_s1_burst_adapter:source0_channel -> ledG_s1_agent:cp_channel
	...
	wire  [112:0] router_005_src_data;                                                    // router_005:src_data -> hex_display_s1_rsp_width_adapter:in_data
	wire    [7:0] router_005_src_channel;                                                 // router_005:src_channel -> hex_display_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] hex_display_s1_rsp_width_adapter_src_data;                              // hex_display_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          hex_display_s1_rsp_width_adapter_src_ready;                             // rsp_demux_004:sink_ready -> hex_display_s1_rsp_width_adapter:out_ready
	wire    [7:0] hex_display_s1_rsp_width_adapter_src_channel;                           // hex_display_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire  [112:0] router_006_src_data;                                                    // router_006:src_data -> ledR_s1_rsp_width_adapter:in_data
	wire    [7:0] router_006_src_channel;                                                 // router_006:src_channel -> ledR_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] ledr_s1_rsp_width_adapter_src_data;                                     // ledR_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          ledr_s1_rsp_width_adapter_src_ready;                                    // rsp_demux_005:sink_ready -> ledR_s1_rsp_width_adapter:out_ready
	wire    [7:0] ledr_s1_rsp_width_adapter_src_channel;                                  // ledR_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire  [112:0] router_007_src_data;                                                    // router_007:src_data -> ledG_s1_rsp_width_adapter:in_data
	wire    [7:0] router_007_src_channel;                                                 // router_007:src_channel -> ledG_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] ledg_s1_rsp_width_adapter_src_data;                                     // ledG_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          ledg_s1_rsp_width_adapter_src_ready;                                    // rsp_demux_006:sink_ready -> ledG_s1_rsp_width_adapter:out_ready
	wire    [7:0] ledg_s1_rsp_width_adapter_src_channel;                                  // ledG_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	wire          router_008_src_endofpacket;                                             // router_008:src_endofpacket -> push_button_s1_rsp_width_adapter:in_endofpacket
	wire          router_008_src_valid;                                                   // router_008:src_valid -> push_button_s1_rsp_width_adapter:in_valid
	wire          router_008_src_startofpacket;                                           // router_008:src_startofpacket -> push_button_s1_rsp_width_adapter:in_startofpacket
	wire  [112:0] router_008_src_data;                                                    // router_008:src_data -> push_button_s1_rsp_width_adapter:in_data
	wire    [7:0] router_008_src_channel;                                                 // router_008:src_channel -> push_button_s1_rsp_width_adapter:in_channel
	wire          router_008_src_ready;                                                   // push_button_s1_rsp_width_adapter:in_ready -> router_008:src_ready
	wire          push_button_s1_rsp_width_adapter_src_endofpacket;                       // push_button_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_007:sink_endofpacket
	wire          push_button_s1_rsp_width_adapter_src_valid;                             // push_button_s1_rsp_width_adapter:out_valid -> rsp_demux_007:sink_valid
	wire          push_button_s1_rsp_width_adapter_src_startofpacket;                     // push_button_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_007:sink_startofpacket
	wire  [148:0] push_button_s1_rsp_width_adapter_src_data;                              // push_button_s1_rsp_width_adapter:out_data -> rsp_demux_007:sink_data
	wire          push_button_s1_rsp_width_adapter_src_ready;                             // rsp_demux_007:sink_ready -> push_button_s1_rsp_width_adapter:out_ready
	wire    [7:0] push_button_s1_rsp_width_adapter_src_channel;                           // push_button_s1_rsp_width_adapter:out_channel -> rsp_demux_007:sink_channel
	...
	wire  [148:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> hex_display_s1_cmd_width_adapter:in_data
	wire    [7:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> hex_display_s1_cmd_width_adapter:in_channel
	...
	wire  [148:0] cmd_mux_005_src_data;                                                   // cmd_mux_005:src_data -> ledR_s1_cmd_width_adapter:in_data
	wire    [7:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> ledR_s1_cmd_width_adapter:in_channel
	...
	wire  [112:0] ledr_s1_cmd_width_adapter_src_data;                                     // ledR_s1_cmd_width_adapter:out_data -> ledR_s1_burst_adapter:sink0_data
	wire          ledr_s1_cmd_width_adapter_src_ready;                                    // ledR_s1_burst_adapter:sink0_ready -> ledR_s1_cmd_width_adapter:out_ready
	wire    [7:0] ledr_s1_cmd_width_adapter_src_channel;                                  // ledR_s1_cmd_width_adapter:out_channel -> ledR_s1_burst_adapter:sink0_channel
	...
	wire  [148:0] cmd_mux_006_src_data;                                                   // cmd_mux_006:src_data -> ledG_s1_cmd_width_adapter:in_data
	wire    [7:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> ledG_s1_cmd_width_adapter:in_channel
	...
	wire  [112:0] ledg_s1_cmd_width_adapter_src_data;                                     // ledG_s1_cmd_width_adapter:out_data -> ledG_s1_burst_adapter:sink0_data
	wire          ledg_s1_cmd_width_adapter_src_ready;                                    // ledG_s1_burst_adapter:sink0_ready -> ledG_s1_cmd_width_adapter:out_ready
	wire    [7:0] ledg_s1_cmd_width_adapter_src_channel;                                  // ledG_s1_cmd_width_adapter:out_channel -> ledG_s1_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_endofpacket;                                            // cmd_mux_007:src_endofpacket -> push_button_s1_cmd_width_adapter:in_endofpacket
	wire          cmd_mux_007_src_valid;                                                  // cmd_mux_007:src_valid -> push_button_s1_cmd_width_adapter:in_valid
	wire          cmd_mux_007_src_startofpacket;                                          // cmd_mux_007:src_startofpacket -> push_button_s1_cmd_width_adapter:in_startofpacket
	wire  [148:0] cmd_mux_007_src_data;                                                   // cmd_mux_007:src_data -> push_button_s1_cmd_width_adapter:in_data
	wire    [7:0] cmd_mux_007_src_channel;                                                // cmd_mux_007:src_channel -> push_button_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_007_src_ready;                                                  // push_button_s1_cmd_width_adapter:in_ready -> cmd_mux_007:src_ready
