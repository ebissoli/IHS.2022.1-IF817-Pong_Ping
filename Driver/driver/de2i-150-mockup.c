...
#include <linux/uacess.h> /* copy_*_user functions */
...
static struct pci_driver pci_ops = {.name = "alterahello",
                                    .id_table = pci_ids,
                                    .probe = my_pci_probe,
...
static const char *perf_names[] = {"switches",  "p_buttons",  "display_l",
                                   "display_r", "green_leds", "red_leds"};
